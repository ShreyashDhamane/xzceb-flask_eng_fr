"""
    contains functions to convert the english to french and vice cersa
"""
import json
import os
...
language_translator = LanguageTranslatorV3(version='2022-06-30',
...
def english_to_french(english_text):
    """
    converts the english to french
    """
...
def french_to_english(french_text):
    """
    converts the french to english
    """
